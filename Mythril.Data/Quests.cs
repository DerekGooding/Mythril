...
public partial class Quests(Items items) : IContent<Quest>
{
    ...
    [
        new Quest("Prologue", "Watch the intro cinematic.", 3,
            [], [], QuestType.Single),

        new Quest("Tutorial Section", "Complete the tutorial section of the game.", 3,
            [], [new ItemQuantity(items.BasicGem)], QuestType.Recurring),

        new Quest("Visit Starting Town", "Time to see if there is anything useful here.", 3,
            [],[], QuestType.Single),
        ...
        new Quest("Learn About Cadences", "The old man teaches you how to unlock your true potential.", 3,
            [],[],QuestType.Single),
